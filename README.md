...
- **WhatsApp** — Multi-vendor abstraction: UltraMsg, WaSenderAPI, OpenWA, Evolution-Go, WAHA.
...
- **Security** — HMAC SHA256 (OpenWA / WAHA), shared secret (WaSenderAPI / Evolution-Go / WAHA) webhook validation.
